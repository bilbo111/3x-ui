...
<p align="left">
  <a href="https://buymeacoffee.com/bilbo111" target="_blank">
...
```
bash <(curl -Ls https://raw.githubusercontent.com/bilbo111/3x-ui/master/install.sh)
```
...
```
VERSION=v1.7.9 && <(curl -Ls "https://raw.githubusercontent.com/bilbo111/3x-ui/$VERSION/install.sh") $VERSION
```
...
wget https://github.com/bilbo111/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. **Склонируйте репозиторий проекта:**
   ...
   ```sh
   git clone https://github.com/bilbo111/3x-ui.git
   cd 3x-ui
   ```
...
[![Stargazers over time](https://starchart.cc/bilbo111/3x-ui.svg?variant=adaptive)](https://starchart.cc/bilbo111/3x-ui)
